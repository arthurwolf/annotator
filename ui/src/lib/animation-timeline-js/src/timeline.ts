...
export class Timeline extends TimelineEventsEmitter {
  ...
  _scrollAreaClickOrDragStarted = false;
    ...
    public position_a : number|null = null;
    public position_b : number|null = null;
  ...
  constructor(options: TimelineOptions | null = null, model: TimelineModel | null = null) {
    ...
    console.log(`# Timeline constructor (with our modified class)`);
  ...
  _renderRows = (): void => {
    ...
    try {
      ...
      viewModel.rowsViewModels.forEach((rowViewModel) => {
        ...
        if(row_index == this.selected_row){
  ...
  _renderTimeline = (): void => {
    ...
    try {
      ...
      if(this.position_a){
       ...
       //const rainbow = `#f44336 #9c27b0 #2196f3 #4caf50 #feea3a #ff9800`.split(' ');
